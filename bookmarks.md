...
- [*nix file-names are overly permissive](https://dwheeler.com/essays/fixing-unix-linux-filenames)
- [Files are hard](https://danluu.com/file-consistency)
- [NetCat cheat-sheet](https://camilotejeiro.github.io/2017/05/17/netcat-command-linux.html)
- [*Actually* accidentally Turing-complete](https://gwern.net/turing-complete#accidentally-turing-complete)
...
- Likely, [the most comprehensive debunking of theistic religions](https://web.archive.org/web/20250527070909/https://whywontgodhealamputees.com/). See also [this](https://rationalwiki.org/wiki/Why_Won%27t_God_Heal_Amputees) and [this](https://web.archive.org/web/20250602132519/https://www.godisimaginary.com/).
